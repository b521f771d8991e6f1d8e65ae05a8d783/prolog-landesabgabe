...
export function CodeView({
	...
	const [isTaskRequestInProgress, setIsTaskRequestInProgress] =
	...
	const onDownloadClicked = (): void => {
		...
		const fileNameSanitized = fileName.startsWith("-")
	...
	const showFooter =
		...
		showButtons.magnify ||
		showButtons.createNormFromSelection;
...
function CopyButton({ text }: { text: string }) {
	...
	const [copyButtonText, setCopyButtonText] = useState<string>(
		copyButtonOriginalText,
	);
	const [copyButtonLeftSection, setCopyButtonLeftSection] = useState<string>(
		copyButtonOriginalEmoji,
	);
	const [copyButtonColor, setCopyButtonColor] = useState<string>(
		copyButtonOriginalColor,
	);
