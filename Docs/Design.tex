...
\begin{itemize}
    ...
    \item \textbf{LogicKit}: Zuständig für die Ausführung von Gesetzen.
\end{itemize}

Auf die Struktur der komplexeren Module wird in eigenen Abschnitten eingegangen.

\section{LogicKit}
Das eigentliche Herzstück von LegalXML ist LogicKit, dieses Modul kümmert sich um die Ausführung von Gesetzen.
