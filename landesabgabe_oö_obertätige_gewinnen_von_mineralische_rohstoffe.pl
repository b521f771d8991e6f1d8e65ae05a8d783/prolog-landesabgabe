...
:- use_module(abgabe).
:- use_module(bergbau).
:- use_module(gebietskörperschaften).
:- use_module(mineralrohstoffgesetz).
...
abgabe_auf(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, landesabgabe, oberösterreich, bergbau(gewinnen, obertags, mineralische_rohstoffe)).

% andere Abgaben (für Demozecke)
abgabe_auf(hundehalterabgabe, gemeinde, X, zivilrecht_eigentümer(hund)) :-
    gemeinde(österreich, X).
abgabe_auf(humusabgabe, gemeinde, tragwein, zivilrecht_eigentümer(humus)).
...
ausnahme(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X) :-
    current_predicate(abraummaterial/1),
    abraummaterial(X).

ausnahme(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X) :-
    current_predicate(entstammt_fließgewässer/1),
    entstammt_fließgewässer(X).

ausnahme(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X) :-
    % bundeseigener_rohstoff defined in mineralrohstoffgesetz.pl
    bundeseigener_rohstoff(X).

ausnahme(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, kohle).
...
ausnahme(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, preis(X, eur)) :-
    X < 120.
...
ertragsanteil(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe
    , gemeinde
...
abbraummaterial(X) :-
    ...
    verwendet_fuer(geländegestaltung, X).
...
betreiber(X) :-
    (natürliche_person(X);juristische_person(X);sonstiger_rechtsträger(X)),
    (gewerblich(X);berufsmäßig(X)).
...
abgabepfichtiger(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, betreiber_gewinnungsstätte).

abgabepflichtiger(bundesteuer_ust, juristische_person_unternehmer_lt_P2UStG). % example of a reference
abgabepflichtiger(bundessteuer_köst, juristische_personen_körperschaften_lt_P1KStG).
...
abgabe_höhe(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, tonne_gewonnener_u_verwerteter_rohstoff_in_kg, 15.95, eur_2017). % eur_2017 ... this means that the levy is 15.94 in 2017's EUR
abgabe_höhe(grundstücke, m2, 12, dollar).
...
abgabe_höhe_index(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, statistik_austria_vpi).
abgabe_höhe_index_angapassen_wenn(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, änderung, großer, 5, percent).
abgabe_höhe_runden(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, symmetrisch_IEEE_754_ohne_regel_3).

% §6 Entstehen der Abgabeschuld:
% Die Abgabenschuld entsteht zu dem Zeitpunkt, in dem das gewonnene Material verwertet wird.
abgabeschuld(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, verwertung_gewonnenes_material).
...
aufzeichnungspflicht(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe).
...
% HINT: try anzeigepflicht(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X).
anzeigepflicht(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X) :-
    abgabepfichtiger(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X).
...
zur_abgabenbemessung_verepflichtet(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X) :-
    abgabepflichtiger(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, X).
abgabenerklärung_einzureichen_bis(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, allgemein, 0430).
abgabenerklärung_einzureichen_bis(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, erstes_halbjahr_2018, 1031).
...
abgabenerklärung_aufbau(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, gewinnungsstätte, zivilrechtliche_leistungen).
abgabenschuld_zu_entrichten_bis(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, allgemein, 0430).
abgabenschuld_zu_entrichten_bis(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, erstes_halbjahr_2018, 1031).

% §10 Behörde:
% Abgabenbehörde ist die Landesregierung.
abgabenbehörde(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, landesregierung_oö).
...
inkrafttreten(landesabgabe_oö_obertätige_gewinnen_von_mineralische_rohstoffe, 20180101).
